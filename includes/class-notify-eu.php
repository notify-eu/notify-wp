...
class Notify_Eu {
	 ...
	 *
	 * - Notify_Loader. Orchestrates the hooks of the plugin.
	 * - Notify_i18n. Defines internationalization functionality.
	 * - Notify_Admin. Defines all hooks for the admin area.
	 * - Notify_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Notify_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
